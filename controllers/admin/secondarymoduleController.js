...
// const SecondaryModule = require('../../models/admin/secondarymodule'); // new model

// // Allowed titles for secondary modules
// const SECONDARY_MODULE_TITLES = [
//   'cakes', 'invitation and printing', 'boutique', 
//   'stage decoration', 'florist', 'mehandi', 
//   'light', 'bouncers', 'security'
// ];
...
// // Create Secondary Module
// exports.createSecondaryModule = async (req, res) => {
//   try {
//     const { title, categories } = req.body;

//     if (!SECONDARY_MODULE_TITLES.includes(title)) {
...
//       icon: req.file ? `uploads/secondaryModules/${req.file.filename}` : null
//     };
...
//     if (title && !SECONDARY_MODULE_TITLES.includes(title)) {
//       return res.status(400).json({ error: 'Invalid module title' });
//     }

//     if (req.file) {
//       deleteFileIfExists(path.join(__dirname, `../../${module.icon}`));
//       module.icon = `uploads/secondaryModules/${req.file.filename}`;
//     }
